...
// }
// console.log(eatPizza('HUYLO'))
//  console.log(makePizza("Ultracheese",eatPizza));
...
//    orderedItems.forEach(function (numbers, index){
//      if (numbers> value) {
...
// }
// console.log(filterArray(orderedItems, 7));
...
//   firstArray.forEach(function (numbers, index){
...
// if (numbers% 2 === 0) {
//  newArrey.push(numbers = numbers+ value);
//   }
//   else {
//   newArrey.push(numbers);
...
//   // for (let i = 0; i < numbers.length; i += 1) {
//   //   if (numbers[i] % 2 === 0) {
//   //     newArrey.push(numbers[i] = numbers[i] + value);
//   //   }
//   //   else {
...
// console.log(changeEven([1, 2, 3,4], 10));
...
//   },
// ];
// let uaerName = users.map(user => user.name)
...
// console.log(students.indexOf("Mango"));

// const allCourses = students.flatMap(student => student.courses);
// // ["mathematics", "physics", "science", "mathematics", "physics", "biology"];
// console.log(allCourses);
// const uniqueCourses = allCourses.filter(
//   (corse, index, array) => array.indexOf(corse) === index
// );
...
//     // allGenres.filter((genre, index, array) => array.indexOff(genre) === index);
...
//     const uniqueFiends = allFriends.filter((friend, indx, array) =>
//         array.indexOf(friend) === indx
...
//    const isActiveArr = users.filter(
...
//   users.reduce((allFrends, user) => {
//   const totalFriends= allFrends+user.friends.length
//   // allFrends.push(...user.friends);
...
// const sortedByAscendingRating = [...books].sort(({ rating:a },{ rating:b }, ) => b-a);
// console.log(sortedByAscendingRating);
// const sortedByDescentingRating = [...books].sort(({ rating:a },{ rating:b }, ) => a-b);
...
//       return [...users].sort(({name:a}, {name:b})=> b.localeCompare(a))
// };
...
// const names =
//   [...books].sort(({ author: a }, { author: b }) => a.localeCompare(b))
...
//   return [...users].sort((a, b) => a.friends.length - b.friends.length).map(element => element.name);
...
//   return users.flatMap(item => item.friends).filter((friend, idx, array) => array.indexOf(friend) === idx).sort((a,b) => a.localeCompare(b));
// };
...
//   return users.filter(value => value.gender === gender).reduce((total, user)=> total += user.balance , 0 )
